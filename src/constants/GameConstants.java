...
//                return 20040220;
    ...
    public static int getLinkSkillByJob(final int job) {
        if (MapleJob.is重砲指揮官(job)) { //Pirate Blessing
            ...
            return 80000070;
        } else if (MapleJob.is双弩精灵(job)) { //Elven Blessing
            return 80001040;
            ...
            return 80000006;
        } else if (MapleJob.is尖兵(job)) { //Hybrid Logic
            return 80000047;
        } else if (MapleJob.is林芝林(job)) { //Focus Spirit
            return 80010006;
        }
        return 0;
    }
    ...
    public static boolean isSeparatedSp(int job) {
        return !MapleJob.is管理員(job) && !MapleJob.is林芝林(job) && !MapleJob.is皮卡啾(job);
    }
