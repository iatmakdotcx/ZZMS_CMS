...
public class GUISearchGenerator extends javax.swing.JFrame implements GUIWindow {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("检索类型:");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "全部", "道具", "NPC", "地圖", "怪物", "任務", "技能", "职业", "伺服器包頭", "用戶端包頭", "髮型", "臉型" }));
