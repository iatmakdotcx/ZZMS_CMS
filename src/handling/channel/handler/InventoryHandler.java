...
public class InventoryHandler {
    ...
    public static void UseGoldenHammer(final LittleEndianAccessor slea, final MapleClient c) {
        ...
        if (equip == null || toUse == null || toUse.getItemId() != itemId || toUse.getQuantity() < 1 || c.getPlayer().hasBlockedInventory() || !(ItemConstants.类型.鐵鎚(toUse.getItemId()) && itemId != 2472000)) {
            c.getSession().write(CWvsContext.enableActions());
            return;
        }
    ...
    public final static void UseSoulEnchanter(final LittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {//魂卷
        ...
        final MapleItemInformationProvider ii = MapleItemInformationProvider.getInstance();
        if (!ItemConstants.类型.靈魂卷軸_附魔器(enchanter.getItemId()) || nEquip.getSoulEnchanter() != 0 || !ItemConstants.类型.武器(nEquip.getItemId())) {
            if (c.getPlayer().isShowErr()) {
                c.getPlayer().showMessage(11, "砸卷錯誤:使用的捲軸不是靈魂捲軸-" + !ItemConstants.类型.靈魂卷軸_附魔器(enchanter.getItemId()) + " 裝備已經上了魂卷-" + (nEquip.getSoulEnchanter() != 0) + " 使用捲軸的裝備不是武器-" + (!ItemConstants.类型.武器(nEquip.getItemId())));
            }
            c.getSession().write(CWvsContext.enableActions());
            return;
        }
    ...
    public final static void UseSoulScroll(final LittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {//魂珠
        ...
        if (!ItemConstants.类型.靈魂寶珠(soulid) || skillid == 0 || nEquip.getSoulEnchanter() == 0 || !ItemConstants.类型.武器(nEquip.getItemId())) {
            if (c.getPlayer().isShowErr()) {
                c.getPlayer().showMessage(11, "砸卷錯誤:使用的捲軸不是靈魂寶珠-" + !ItemConstants.类型.靈魂寶珠(soulid) + " 寶珠未添加技能-" + (skillid == 0) + " 未上魂卷-" + (nEquip.getSoulEnchanter() == 0) + " 使用捲軸的裝備不是武器-" + (!ItemConstants.类型.武器(nEquip.getItemId())));
            }
            c.getSession().write(CWvsContext.enableActions());
            return;
        }
    ...
    public static boolean UseUpgradeScroll(final short slot, final short dst, final short ws, final MapleClient c, final MapleCharacter chr, final int vegas, final boolean legendarySpirit) {
        ...
        if (ItemConstants.类型.阿斯旺卷軸(scroll.getItemId())) {//阿斯旺捲軸
        ...
        } else if (!ItemConstants.类型.特殊卷軸(scroll.getItemId()) && !ItemConstants.类型.白醫卷軸(scroll.getItemId()) && !ItemConstants.类型.裝備強化卷軸(scroll.getItemId()) && !ItemConstants.类型.潛能卷軸(scroll.getItemId()) && !ItemConstants.类型.附加潛能卷軸(scroll.getItemId()) && !ItemConstants.类型.回真卷軸(scroll.getItemId())) {
        ...
        } else if (ItemConstants.类型.裝備強化卷軸(scroll.getItemId())) {//強化捲軸
        ...
        } else if (ItemConstants.类型.潛能卷軸(scroll.getItemId())) {//潛能捲軸
            ...
            if ((!isEpic && !isUnique && !isLegend && toScroll.getState(false) >= 1) || (isEpic && toScroll.getState(false) >= 18) || (isUnique && toScroll.getState(false) >= 19) || (isLegend && toScroll.getState(false) >= 20) || (toScroll.getLevel() == 0 && toScroll.getUpgradeSlots() == 0 && !ItemConstants.类型.副手(toScroll.getItemId()) && !ItemConstants.类型.能源(toScroll.getItemId()) && !ItemConstants.类型.特殊潛能道具(toScroll.getItemId())/* && !isEpic && !isUnique*/) || vegas > 0 || ii.isCash(toScroll.getItemId()) || ItemConstants.类型.無法潛能道具(toScroll.getItemId())) {
                if (chr.isShowErr()) {
                    chr.showInfo("砸卷錯誤", true, "isPotentialScroll" + (toScroll.getState(false) >= 1) + " " + (toScroll.getLevel() == 0 && toScroll.getUpgradeSlots() == 0 && !ItemConstants.类型.副手(toScroll.getItemId()) && !ItemConstants.类型.能源(toScroll.getItemId()) && !ItemConstants.类型.特殊潛能道具(toScroll.getItemId())) + "vegas" + (vegas > 0) + "裝備是否是為點裝" + ii.isCash(toScroll.getItemId()) + "特殊潛能道具" + ItemConstants.类型.無法潛能道具(toScroll.getItemId()));
                }
                c.getSession().write(InventoryPacket.getInventoryFull());
                c.getSession().write(CWvsContext.enableActions());
                c.getSession().write(CField.enchantResult(0, toScroll.getItemId()));
        ...
        } else if (ItemConstants.类型.附加潛能卷軸(scroll.getItemId())) {//附加潛能捲軸
            if (toScroll.getState(true) >= 1 || toScroll.getState(false) == 0 || (toScroll.getLevel() == 0 && toScroll.getUpgradeSlots() == 0 && !ItemConstants.类型.副手(toScroll.getItemId()) && !ItemConstants.类型.能源(toScroll.getItemId()) && !ItemConstants.类型.特殊潛能道具(toScroll.getItemId())) || vegas > 0 || ii.isCash(toScroll.getItemId()) || ItemConstants.类型.無法潛能道具(toScroll.getItemId())) {
                if (chr.isShowErr()) {
        ...
        } else if (ItemConstants.类型.特殊卷軸(scroll.getItemId())) {//特殊捲軸
            boolean re = false;
            if (ii.isCash(toScroll.getItemId())) {
                ...
                re = true;
            } else if (ItemConstants.类型.幸運日卷軸(scroll.getItemId()) && ItemFlag.LUCKY_DAY.check(toScroll.getFlag())) {//幸運日
                if (chr.isShowErr()) {
                    chr.showInfo("砸卷錯誤", true, "已有效果" + ItemFlag.LUCKY_DAY.check(toScroll.getFlag()));
                }
                re = true;
            } else if (ItemConstants.类型.安全卷軸(scroll.getItemId()) && ItemFlag.SLOTS_PROTECT.check(toScroll.getFlag())) {//安全捲軸
                if (chr.isShowErr()) {
                    chr.showInfo("砸卷錯誤", true, "已有效果" + ItemFlag.SLOTS_PROTECT.check(toScroll.getFlag()));
                }
                re = true;
            } else if (ItemConstants.类型.卷軸保護卡(scroll.getItemId()) && ItemFlag.SCROLL_PROTECT.check(toScroll.getFlag())) {//捲軸保護卡
                if (chr.isShowErr()) {
                    chr.showInfo("砸卷錯誤", true, "已有效果" + ItemFlag.SCROLL_PROTECT.check(toScroll.getFlag()));
                }
                re = true;
            }
            if (ItemConstants.类型.保護卷軸(scroll.getItemId())) {//保護捲軸
            ...
            switch (scroll.getItemId()) {
                ...
                case 5068200://寵物卷軸保護卡
                    if (ItemConstants.类型.寵物裝備(toScroll.getItemId())) {
                        break;
                    } else {
                        if (chr.isShowErr()) {
        ...
        } else if (ItemConstants.类型.白醫卷軸(scroll.getItemId())) {//白衣捲軸
        ...
        if (!ItemConstants.卷軸.canScroll(toScroll.getItemId()) && !ItemConstants.类型.混沌卷軸(toScroll.getItemId())) {
            if (chr.isShowErr()) {
                chr.showInfo("砸卷錯誤", true, "捲軸不能對裝備進行砸卷 " + !ItemConstants.卷軸.canScroll(toScroll.getItemId()) + " 不是混沌捲軸 " + !ItemConstants.类型.混沌卷軸(toScroll.getItemId()));
            }
            c.getSession().write(InventoryPacket.getInventoryFull());
            c.getSession().write(CWvsContext.enableActions());
            c.getSession().write(CField.enchantResult(0, toScroll.getItemId()));
        ...
        if ((ItemConstants.类型.白醫卷軸(scroll.getItemId()) || ItemConstants.类型.普通升級卷軸(scroll.getItemId()) || ItemConstants.类型.混沌卷軸(scroll.getItemId())) && (vegas > 0 || ii.isCash(toScroll.getItemId()))) {
            if (chr.isShowErr()) {
                chr.showInfo("砸卷錯誤", true, "捲軸是白醫捲軸 " + ItemConstants.类型.白醫卷軸(scroll.getItemId()) + " 是普通捲軸 " + ItemConstants.类型.普通升級卷軸(scroll.getItemId()) + " 是混沌捲軸 " + ItemConstants.类型.混沌卷軸(scroll.getItemId()) + "vegas" + (vegas > 0 || ii.isCash(toScroll.getItemId())));
            }
            c.getSession().write(InventoryPacket.getInventoryFull());
            c.getSession().write(CWvsContext.enableActions());
            c.getSession().write(CField.enchantResult(0, toScroll.getItemId()));
        ...
        if (ItemConstants.类型.提升卷(scroll.getItemId()) && toScroll.getDurability() < 0) { //not a durability item
            if (chr.isShowErr()) {
                chr.showInfo("砸卷錯誤", true, "是提升卷 " + ItemConstants.类型.提升卷(scroll.getItemId()) + " getDurability " + (toScroll.getDurability() < 0));
            }
            c.getSession().write(InventoryPacket.getInventoryFull());
            c.getSession().write(CWvsContext.enableActions());
            c.getSession().write(CField.enchantResult(0, toScroll.getItemId()));
            return false;
        } else if ((!ItemConstants.类型.提升卷(scroll.getItemId()) && !ItemConstants.类型.潛能卷軸(scroll.getItemId()) && !ItemConstants.类型.裝備強化卷軸(scroll.getItemId()) && !ItemConstants.类型.白醫卷軸(scroll.getItemId()) && !ItemConstants.类型.特殊卷軸(scroll.getItemId()) && !ItemConstants.类型.混沌卷軸(scroll.getItemId())) && toScroll.getDurability() >= 0) {
            if (chr.isShowErr()) {
        ...
        if (scroll.getItemId() == 2040727) {//鞋子防滑卷軸10%
            if (!ItemConstants.类型.鞋子(toScroll.getItemId())) {
                if (chr.isShowErr()) {
                    chr.showInfo("砸卷錯誤", true, "道具不是鞋子" + !ItemConstants.类型.鞋子(toScroll.getItemId()));
                }
                c.getSession().write(InventoryPacket.getInventoryFull());
                c.getSession().write(CWvsContext.enableActions());
                c.getSession().write(CField.enchantResult(0, toScroll.getItemId()));
            ...
            if (!ItemConstants.类型.披風(toScroll.getItemId())) {
                if (chr.isShowErr()) {
                    chr.showInfo("砸卷錯誤", true, "道具不是披風" + !ItemConstants.类型.披風(toScroll.getItemId()));
                }
                c.getSession().write(InventoryPacket.getInventoryFull());
                c.getSession().write(CWvsContext.enableActions());
                c.getSession().write(CField.enchantResult(0, toScroll.getItemId()));
        ...
        } else if (!ItemConstants.类型.機器人心臟(toScroll.getItemId()) && (ItemConstants.类型.提升卷(scroll.getItemId()) || ItemConstants.类型.普通升級卷軸(scroll.getItemId()))) {//普通捲軸
            switch (scroll.getItemId() % 1000 / 100) {
                case 0: //單手1h
                    if (ItemConstants.类型.雙手武器(toScroll.getItemId()) || !(ItemConstants.类型.武器(toScroll.getItemId()) || ItemConstants.类型.雙刀(toScroll.getItemId()))) {
                        c.getSession().write(CWvsContext.enableActions());
                        c.getSession().write(CField.enchantResult(0, toScroll.getItemId()));
                        if (chr.isShowErr()) {
                            chr.showInfo("砸卷錯誤", true, "是雙手武器" + ItemConstants.类型.雙手武器(toScroll.getItemId()) + " 不是武器" + !(ItemConstants.类型.武器(toScroll.getItemId()) || ItemConstants.类型.雙刀(toScroll.getItemId())));
                        }
                        return false;
                    }
                    break;
                case 1: //雙手2h
                    if (!ItemConstants.类型.雙手武器(toScroll.getItemId()) || !ItemConstants.类型.武器(toScroll.getItemId())) {
                        c.getSession().write(CWvsContext.enableActions());
                        c.getSession().write(CField.enchantResult(0, toScroll.getItemId()));
                        if (chr.isShowErr()) {
                            chr.showInfo("砸卷錯誤", true, "不是雙手武器" + !ItemConstants.类型.雙手武器(toScroll.getItemId()) + " 不是武器" + !ItemConstants.类型.武器(toScroll.getItemId()));
                        }
                        return false;
                    }
                    break;
                case 2: //防具armor
                    if (ItemConstants.类型.飾品(toScroll.getItemId()) || ItemConstants.类型.武器(toScroll.getItemId()) || ItemConstants.类型.雙刀(toScroll.getItemId())) {
                        c.getSession().write(CWvsContext.enableActions());
                        c.getSession().write(CField.enchantResult(0, toScroll.getItemId()));
                        if (chr.isShowErr()) {
                            chr.showInfo("砸卷錯誤", true, "是飾品" + ItemConstants.类型.飾品(toScroll.getItemId()) + " 是武器" + (ItemConstants.类型.武器(toScroll.getItemId()) || ItemConstants.类型.雙刀(toScroll.getItemId())));
                        }
                        return false;
                    }
                    break;
                case 3: //飾品accessory
                    if (!ItemConstants.类型.飾品(toScroll.getItemId()) || ItemConstants.类型.武器(toScroll.getItemId()) || ItemConstants.类型.雙刀(toScroll.getItemId())) {
                        ...
                        c.getSession().write(CField.enchantResult(0, toScroll.getItemId()));
                        if (chr.isShowErr()) {
                            chr.showInfo("砸卷錯誤", true, "不是飾品" + !ItemConstants.类型.飾品(toScroll.getItemId()) + " 是武器" + (ItemConstants.类型.武器(toScroll.getItemId()) || ItemConstants.类型.雙刀(toScroll.getItemId())));
                        }
                        return false;
                    }
                    break;
            }
        } else if (!ItemConstants.类型.機器人心臟(toScroll.getItemId()) && (ItemConstants.类型.TMS特殊卷軸(scroll.getItemId()))) {
        ...
        } else if (ItemConstants.类型.飾品卷軸(scroll.getItemId()) && !ItemConstants.类型.飾品(toScroll.getItemId())) {
            if (chr.isShowErr()) {
            ...
            c.getSession().write(CField.enchantResult(0, toScroll.getItemId()));
            return false;
        } else if (!ItemConstants.类型.混沌卷軸(scroll.getItemId()) && //混沌捲軸
                !ItemConstants.类型.白醫卷軸(scroll.getItemId()) && //白醫
                !ItemConstants.类型.裝備強化卷軸(scroll.getItemId()) && //強化
                !ItemConstants.类型.潛能卷軸(scroll.getItemId()) && //潛能
                !ItemConstants.类型.附加潛能卷軸(scroll.getItemId()) && //附加潛能
                !ItemConstants.类型.特殊卷軸(scroll.getItemId()) &&//特殊捲軸
                !ItemConstants.类型.回真卷軸(scroll.getItemId()) && //還原捲軸
        ...
        if (scrolled == null) {
            ...
            } else if ((ItemConstants.类型.白醫卷軸(scroll.getItemId()) && scrolled.getUpgradeSlots() > oldSlots)) {
                scrollSuccess = Equip.ScrollResult.SUCCESS;
            } else if ((ItemConstants.类型.回真卷軸(scroll.getItemId()) && scrolled != toScroll)) {
                scrolled = toScroll;
                scrollSuccess = Equip.ScrollResult.SUCCESS;
            } else {
                scrollSuccess = Equip.ScrollResult.FAIL;
            }
            if (ItemFlag.SHIELD_WARD.check(oldFlag) && !ItemConstants.类型.特殊卷軸(scroll.getItemId())) {
                scrolled.removeFlag((short) ItemFlag.SHIELD_WARD.getValue());
            }
        ...
        if (scrollSuccess == Equip.ScrollResult.CURSE) {
            ...
            if (ItemConstants.类型.回真卷軸(scroll.getItemId())) {
    ...
    public static void UseAbyssScroll(final LittleEndianAccessor slea, final MapleClient c) {//世界之樹的祝福
        ...
        if (toUse.getItemId() / 100 != 20485 && toUse.getItemId() / 100 != 20486
                || !ItemConstants.类型.装备(item.getItemId())
        ...
        if (eqq.getOldState() < eqq.getState(bonus)) {
            ...
            for (int i = 1; i <= 3; i++) {
                if (eqq.getPotential(i, bonus) >= 60000) {
                    superStat++;
                } else if (ItemConstants.类型.武器(eqq.getItemId()) || eqq.getPotential(i, bonus) >= 40000) {
            ...
            if (trueStat + superStat < 3 || (trueStat + superStat < 2 && ItemConstants.类型.武器(eqq.getItemId()))) {
                return;
            }
    ...
    public static boolean mapleCubeAction(MapleClient c, Equip eq, boolean use, int toLock, boolean free) {
        String[] potStates = {"n", "r", "e", "u", "l"};//無潛能,特殊,稀有,罕見,英雄初心者
        ...
        if (eq.getLevel() == 0 && eq.getUpgradeSlots() == 0 && !ItemConstants.类型.副手(eq.getItemId()) && !ItemConstants.类型.能源(eq.getItemId()) && !ItemConstants.类型.特殊潛能道具(eq.getItemId()) || MapleItemInformationProvider.getInstance().isCash(eq.getItemId()) || ItemConstants.类型.無法潛能道具(eq.getItemId())) {
            c.getPlayer().dropMessage(1, "在這道具無法使用。");
            c.getSession().write(CField.showMapleCubeCost(3, 0));
            return false;
        }

        if (ItemConstants.类型.特殊潛能道具(eq.getItemId()) && potentialState == 0) {
            ...
            switch (toUse.getItemId()) {
                ...
                case 2430016: { //保冷箱
                    ...
                    if (rand >= 0 && rand < 20) {
                        ...
                        //傷害皮膚
                        Integer[] skins = ItemConstants.伤害字型.getDamageSkinsTradeBlock();
                ...
                case 5680021:
                    ...
                    break;
                default:
                    if (ItemConstants.伤害字型.isDamageSkin(toUse.getItemId())) {
                        if (!MapleJob.is神之子(chr.getJob())) {
                            int sitemid = toUse.getItemId();
                            int skinnum = ItemConstants.伤害字型.getDamageSkinNumberByItem(sitemid);
                            if (skinnum == -1) {
    ...
    public static final void UseCashItem(final LittleEndianAccessor slea, final MapleClient c) {
        ...
        switch (itemId) {
            ...
            case 5500000: { // Magic Hourglass 1 day
                ...
                final int days = 1;
                if (item != null && !ItemConstants.类型.飾品(item.getItemId()) && item.getExpiration() > -1 && !ii.isCash(item.getItemId()) && System.currentTimeMillis() + (100 * 24 * 60 * 60 * 1000L) > item.getExpiration() + (days * 24 * 60 * 60 * 1000L)) {
                    boolean change = true;
            ...
            case 5062404: { // 時裝神秘鐵砧
                ...
                if (!ItemConstants.类型.装备(appear.getItemId()) || !ItemConstants.类型.装备(equip.getItemId()) || appear.getItemId() / 10000 != equip.getItemId() / 10000) {
                    if (c.getPlayer().isShowErr()) {
                        c.getPlayer().showInfo("影像合成", false, "外型道具不是裝備:" + !ItemConstants.类型.装备(appear.getItemId()) + " 功能道具不是裝備:" + !ItemConstants.类型.装备(equip.getItemId()) + " 外型道具和功能道具不是同一類型:" + (appear.getItemId() / 10000 != equip.getItemId() / 10000));
                    }
                    c.getSession().write(CWvsContext.getFusionAnvil(false, itemId, 2028093));
                    c.getSession().write(CWvsContext.enableActions());
                    return;
                }
                if (ItemConstants.类型.勳章(equip.getItemId())) {
                    if (itemId != 5062402) {
                        if (c.getPlayer().isShowErr()) {
                ...
                } else if (ItemConstants.类型.防具(equip.getItemId())
                        || ItemConstants.类型.臉飾(equip.getItemId())
                        || ItemConstants.类型.眼飾(equip.getItemId())
                        || ItemConstants.类型.耳環(equip.getItemId())
                        || ItemConstants.类型.盾牌(equip.getItemId())) {
                    if (itemId == 5062404) {
            ...
            case 5521000: { // 與自己分享名牌Karma
                ...
                if (item != null && ItemConstants.类型.装备(item.getItemId()) && ((Equip) item).getKarmaCount() != 0) {
...
//                World.Broadcast.broadcastSmega(CWvsContext.broadcastMsg(3, c.getChannel(), c.getPlayer().getName() + " : " + message, ear));
            ...
            case 5155000: { // 卡勒塔的珍珠(更變精靈耳朵)
                ...
                boolean isMercedes = MapleJob.is双弩精灵(c.getPlayer().getJob());
        ...
        try {
            ...
            if (mapitem.getMeso() > 0) {
                ...
                if (MapleItemInformationProvider.getInstance().isPickupBlocked(mapitem.getItemId())) {
                    ...
                    if (!ItemConstants.类型.宠物(mapitem.getItemId())) {
