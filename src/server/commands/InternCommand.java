        ...
        public int execute(MapleClient c, String[] splitted) {
            if (splitted.length == 2) {
                ...
                if (err) {
                    ...
                    c.getPlayer().dropMessage(-11, splitted[0] + ": <类型> <搜尋訊息>");
                    c.getPlayer().dropMessage(-11, "类型:" + sb.toString());
                }
            }
            return 0;
        }
    ...
    public static class 清理道具 extends CommandExecute {
        ...
        public int execute(MapleClient c, String[] splitted) {
            ...
            if (splitted.length < 2 || player.hasBlockedInventory()) {
                c.getPlayer().dropMessage(5, splitted[0] + " <道具欄:装备 / 消耗 / 其他 / 装饰 / 特殊 / 全部>");
                return 0;
            } else {
                ...
                if (splitted[1].equalsIgnoreCase("装备")) {
                ...
                } else if (splitted[1].equalsIgnoreCase("装饰")) {
                    ...
                    c.getPlayer().dropMessage(5, "找不到道具欄 < 装备 / 消耗 / 其他 / 装饰 / 特殊 / 全部>");
                    return 0;
                }
