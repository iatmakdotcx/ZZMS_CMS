...
public class FileoutputUtil {
    ...
    // Logging output file
    public static final String Acc_Stuck = "日志/日志_AccountStuck.rtf",
            Login_Error = "日志/登入_错误.rtf",
    // IP_Log = "日志/Log_AccountIP.rtf",
    //GMCommand_Log = "日志/Log_GMCommand.rtf",
    // Zakum_Log = "日志/Log_Zakum.rtf",
    //Horntail_Log = "日志/Log_Horntail.rtf",

    Pinkbean_Log = "日志/Pinkbean.rtf",
            ScriptEx_Log = "日志/脚本_异常.txt",
            PacketEx_Log = "日志/数据包_异常.txt", // I cba looking for every error, adding this back in.
            UnknownPacket_Log = "日志/数据包_未知.txt",
            Packet_Log = "日志/数据包收发/Log.txt",
            Packet_Record = "日志/数据包_编写.txt",
            Hacker_Log = "日志/Hacker.rtf",
            Movement_Log = "日志/移动_错误.txt",
            Client_Feedback = "日志/用户端_反馈.txt",
            Client_Error = "日志/用户端_报错.txt",
            Create_Character = "日志/创建角色.txt",
            CommandEx_Log = "日志/指令_异常.txt", //PQ_Log = "Log_PQ.rtf"
            Process_Error = "日志/进程获取_错误.log",
            Monitor_Dir = "日志/监控日志/",
            Shark_Dir = "日志/枫鲨档案/",
            BanLog_Process_Dir = "日志/封号进程/";
    // End
