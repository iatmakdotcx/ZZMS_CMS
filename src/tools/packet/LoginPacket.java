...
//        mplew.write(ServerConstants.MAPLE_TYPE.getType());
    ...
    public static final byte[] getCREATE_VERIFY() {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
...
//        mplew.write(HexTool.getByteArrayFromHexString("1F 0F 2A 78"));
        return mplew.getPacket();
    }
    ...
    public static final void getAuthSuccess(MaplePacketLittleEndianWriter mplew, MapleClient client, boolean second) {
        ...
        if (!second) {
            ...
            mplew.writeMapleAsciiString(SERVER_NAME);
        }
        mplew.writeInt(client.getAccID());
        mplew.write(client.getGender());
//        mplew.write(ServerConfig.DeleteChar ? 1 : 0);//是否开放删除人物
...
//        mplew.writeInt(-1);//176+
    ...
    public static byte[] getServerList(WorldConstants.Option world) {
        ...
        mplew.writeShort(world.getWorld());
...
//            mplew.writeInt(Math.max(load * 55 / ServerConfig.CHANNEL_MAX_CHAR_VIEW, 1));
    ...
    public static byte[] getSTATSERVERLIST() {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
...
//        mplew.write(0);
        mplew.writeShort(SendPacketOpcode.STATSERVERLIST.getValue());
        mplew.write(0);
        return mplew.getPacket();
    }
...
//        mplew.write(0);
    ...
    public static byte[] getCharList(String secondpw, List<Integer> charPos, List<MapleCharacter> chars, int charslots) {
        ...
        mplew.writeShort(0);
        mplew.writeLong(4);//可创建的角色数
        mplew.writeInt(-1);
        mplew.writeReversedLong(PacketHelper.getTime(System.currentTimeMillis()));

        mplew.write(0); // 
        mplew.write(0); // 0,1,0xFF
        //mplew.writeInt(0);
        mplew.write(HexTool.getByteArrayFromHexString("00 00 00 00 01 01 01 01 00 01 01 00 01 01 00 01 01 00 01 01 00 01 01 00 01 01 00 01 01 00 01 01 00 01 01 00 01 01 00 01 01 00 01 01 00 01 01 00 01 01 00 00 02 00 01 01 00 00 01 00 01 01 00 01 01 00 00 01 00 01 01 00 01 01 00"));
    ...
    public static byte[] genderNeeded(String login) {
...
//        mplew.write(1);
    ...
    public static byte[] genderChanged(boolean success, String name) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();

        mplew.writeShort(SendPacketOpcode.GENDER_SET.getValue());
        mplew.write(!success);
        mplew.writeMapleAsciiString(name);
        mplew.writeMapleAsciiString("70");
        return mplew.getPacket();
    }
